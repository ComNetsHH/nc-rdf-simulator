...
public:
   ...
   * \param port The port the server will wait on for incoming packets
   */
  RateDecayFloodingAppHelper (uint16_t port, Time sendInterval, Time forwardingJitter, uint32_t packetSize, double maxDistance, double decayFactor, double minGain = 0, double lossRate = 0);
